...
let HRToastMaxWidth       :  CGFloat  = 0.7      // 80% of parent view width
let HRToastMaxHeight      :  CGFloat  = 0.7
...
let HRToastShadowOpacity  : CGFloat   = 0.5
//let HRToastShadowRadius   : CGFloat   = 6.0
let HRToastShadowRadius   : CGFloat   = 2.0
//let HRToastShadowOffset   : CGSize    = CGSizeMake(CGFloat(4.0), CGFloat(4.0))
let HRToastShadowOffset   : CGSize    = CGSizeZero
